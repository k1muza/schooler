    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classroom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='students', to='school_management.classroom')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school_management.school')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_type', models.CharField(choices=[('phone', 'Phone'), ('email', 'Email'), ('address', 'Address')], default='phone', max_length=7)),
                ('contact', models.CharField(max_length=200)),
                ('guardian', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contacts', to='user_management.guardian')),
            ],
        ),
        migrations.AddField(
            model_name='guardian',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('enrolled', 'Enrolled'), ('withdrawn', 'Withdrawn')], default='enrolled', max_length=15)),
                ('classroom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='enrolments', to='school_management.classroom')),
